    ...
    <div className="about-me">
      <Row className="background">
        ...
        <Col className="background-info">
          <ul>
            <li><h5>I obtained my M.S. degree in athletic training in 2016.</h5></li>
            <li><h5>I previously worked as a <b>head athletic
              trainer</b> for a <b>professional ice hockey</b> team in the <b>ECHL</b>.</h5></li>
            <li><h5>As of February 2019, I am an alumn of Flatiron School's online <b>software
              engineering bootcamp</b>.</h5></li>
          </ul>
        </Col>
      </Row>
      <Row className="stack">
      ...
      <Row className="interests">
        ...
        <Col className="interests-info">
          <ul>
            ...
            <li><h5>Ice hockey is my favorite sport to watch - Let's go Pens!</h5></li>
          </ul>
        </Col>
      </Row>
    </div>
