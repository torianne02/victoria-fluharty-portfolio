      ...
      <Row className="intro">
        <Col className="intro-info">
          ...
          <Row className="social-links">
            <a href="https://github.com/torianne02" target="_blank" rel="noopener noreferrer">
              <img className="social-icon" src={githubLogo} alt="Github logo as profile link" />
            </a>
            <a href="https://dev.to/torianne02" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://twitter.com/_torrborr" target="_blank" rel="noopener noreferrer">
              <img className="social-icon" src={twitterLogo} alt="Twitter logo as profile link" />
            </a>
            <a href="https://www.linkedin.com/in/victoria-fluharty-741129b4/" target="_blank" rel="noopener noreferrer">
